...
class KaryawanAdmin (admin.ModelAdmin):
    #list_display = ['nama', 'alamat', 'jenis_kelamin', 'jenis_karyawan', 'jabatan', 'divisi', 'email', 'jumlah_bawahan', 'no_telepon']
    list_display = ['nama', 'jabatan', 'divisi',  'jumlah_bawahan', 'jumlah_aset', 'jenis_karyawan']
